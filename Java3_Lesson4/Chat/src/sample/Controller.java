                ...
                try {
                    while(true) {
                        ...
                        if("/authOk".equals(tokens[0])){
                            ...
                            mainTextArea.clear();
                            setAuthorized(true);
//                            long pointer =FileServices.getFilePointer(getNickname(),2);
//                            System.out.println(pointer);
//                            if(FileServices.getLastMessagesUsePointer(2,pointer+1,getNickname())!=null) {
//                                mainTextArea.appendText(FileServices.getLastMessagesUsePointer(2,pointer+1,getNickname()));
//                            }
                            if(FileServices.getHistoryFromFile(getNickname(),5)!=null) {
                                mainTextArea.appendText(FileServices.getHistoryFromFile(getNickname(),5));
